...
class GenreListAdapter(val list : List<Genre>,val listener: GenreAllClickListener) : RecyclerView.Adapter<GenreListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.genre_title_holder,parent,false)
